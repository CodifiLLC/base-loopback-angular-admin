...
/**
 * Api services for the `CustomUser` model.
 */
@Injectable()
export class CustomUserApi extends BaseLoopBackApi {
  ...
  public findByIdAccessTokens(id: any, fk: any, customHeaders?: Function): Observable<any> {
    ...
    "/CustomUsers/:id/accessTokens/:fk";
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CustomUsers/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.CustomUser#getCurrent
   * @methodOf sdk.CustomUser
   *
   * @description
   *
   ...
   * call to {@link sdk.CustomUser#login} or
   * {@link sdk.CustomUser#getCurrent}. Return null when there
   ...
   * call to {@link sdk.CustomUser#login}
   *
  ...
  /**
   * @name sdk.CustomUser#isAuthenticated
   *
  ...
  /**
   * @name sdk.CustomUser#getCurrentId
   *
